    ...
    <div class="p-4 rounded-lg mt-14">
        ...
        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-sm shadow-sm" id="dropdown-sale">
            ...
            <ul class="py-1" role="none">
                ...
                <li>
                    <button type="button" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 focus:hidden" role="menuitem" data-modal-target="vendas-em-espera" data-modal-toggle="vendas-em-espera">Venda em espera</button>
                </li>
            </ul>
        </div>
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow-sm">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <button data-modal-hide="vendas-em-espera" type="button" class="text-white bg-gray-600 hover:bg-gray-800 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                            Não
                        </button>
