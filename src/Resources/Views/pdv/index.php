    ...
    <div class="p-4 rounded-lg mt-14">
        ...
        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-sm shadow-sm" id="dropdown-sale">
            ...
            <ul class="py-1" role="none">
                ...
                <li>
                    <button type="button" id="em-espera" class="w-full block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 focus:hidden text-left" role="menuitem" data-modal-target="vendas-em-espera" data-modal-toggle="vendas-em-espera">Intervalo</button>
                </li>
            </ul>
        </div>
