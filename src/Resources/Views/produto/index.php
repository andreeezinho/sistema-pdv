    ...
    <div class="p-8 rounded-lg mt-14">
        <nav class="" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="/produtos" class="ms-1 text-sm font-medium text-gray-700 hover:text-gray-600 md:ms-2">Produtos</a>
                    </div>
                </li>
            ...
            <div class="float-end mx-4">
                <a href="/produtos/cadastro" class="text-white bg-gray-800 hover:bg-gray-800 focus:ring-4 focus:ring-gray-500 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">+</a>
            </div>
        </nav>
        ...
        <div class="w-full bg-neutral-50 mt-6 p-4 rounded-lg">
            <div class="relative h-[75dvh] overflow-y-scroll">
                ...
                <?php
                    if(isset($nome_codigo) && !is_null($nome_codigo)){
                ?>
                    <a href="/produtos" class="flex gap-x-1 font-medium border text-gray-800 p-2 px-5 mb-4 rounded-lg text-center bg-gray-300 hover:bg-gray-700 hover:text-white">
                        Limpar
                    </a>
                <?php } ?>
                </div>
                    ...
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        <div class="relative bg-white rounded-lg shadow-sm">
                            ...
                            <div class="p-4 md:p-5">
                                <h3 class="text-center text-gray-700 my-4">Filtrar Produtos</h3>
                                <form action="/produtos" method="GET" class="flex flex-col gap-y-4">
                                    <div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr class="bg-gray-100 border-b border-gray-400 text-gray-800">
                                ...
                                <td class="px-6 py-4 text-<?= ($produto->ativo == 1) ? 'green' : 'red' ?>-500">
                                ...
                                <td class="px-6 py-4 flex gap-x-2 justify-center">
                                    <a href="/produtos/<?= $produto->uuid ?>/editar" class="font-medium text-white p-2 rounded-lg text-center bg-gray-400 hover:bg-gray-700">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125" />
                                        </svg>
                                    </a>
                                    <button type="button" data-modal-target="popup-modal-<?= $produto->uuid ?>" data-modal-toggle="popup-modal-<?= $produto->uuid ?>" class="font-medium text-white p-2 rounded-lg text-center bg-red-400 hover:bg-red-700">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                                    ...
                                    <div id="popup-modal-<?= $produto->uuid ?>" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                            <div class="relative bg-white rounded-lg shadow-sm">
                                                <button type="button" class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="popup-modal-<?= $produto->uuid ?>">
                                                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                                                    </svg>
                                                </button>
                                                <div class="p-4 md:p-5 text-center">
                                                    ...
                                                    <h3 class="mb-5 text-lg font-normal text-gray-700">Deseja deletar esse produto?</h3>
                                                    <h3 class="mb-5 text-sm font-normal text-gray-500"><?= $produto->nome ?></h3>
                                                    <form action="/produtos/<?= $produto->uuid ?>/deletar" method="POST">
                                                        <button data-modal-hide="popup-modal-<?= $produto->uuid ?>" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100">Não, cancelar</button>
