    ...
    <div class="p-8 rounded-lg mt-14">
        <nav class="" aria-label="Breadcrumb">
            ...
            <div class="float-end mx-4">
                <a href="/produtos/cadastro" class="text-white bg-violet-300 hover:bg-violet-800 focus:ring-4 focus:ring-violet-500 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">+</a>
            </div>
        </nav>
                        ...
                        ?>
                            <tr class="bg-violet-100 border-b border-gray-400 text-gray-800">
                                ...
                                <td class="px-6 py-4 flex gap-x-2 justify-center">
                                    <a href="/produtos/<?= $produto->uuid ?>/editar" class="font-medium text-white p-2 rounded-lg text-center bg-violet-400 hover:bg-violet-700">
