                        ...
                        ?>
                            <tr class="odd:bg-gray-100 even:bg-gray-300 border-b border-gray-400 text-gray-800">
                                ...
                                <td class="px-6 py-4 flex gap-x-2 justify-center">
                                    ...
                                    <a href="/usuarios/<?= $usuario->uuid ?>/permissoes" data-modal-target="modal-permissoes-<?= $usuario->uuid ?>" data-modal-toggle="modal-permissoes-<?= $usuario->uuid ?>" class="font-medium text-white p-2 rounded-lg text-center bg-red-400 hover:bg-red-700">
