    ...
    <div class="p-8 rounded-lg mt-14">
        <nav class="" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="/usuarios" class="ms-1 text-sm font-medium text-gray-700 hover:text-violet-600 md:ms-2">Usuários</a>
                    </div>
                </li>
            ...
            <div class="float-end mx-4">
                <a href="/usuarios/cadastro" class="text-white bg-violet-300 hover:bg-violet-800 focus:ring-4 focus:ring-violet-500 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">+</a>
            </div>
        </nav>
