            ...
            <form class="space-y-6" action="/login" method="POST">
                ...
                <div>
                    ...
                    <div class="text-sm mt-3">
                        <a href="/recuperar-senha" class="font-semibold text-gray-400 hover:text-gray-500">Esqueceu sua senha?</a>
                    </div>
                </div>

                <div class="">
                    <button type="submit" class="flex w-full justify-center rounded-md bg-gray-400 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-gray-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600">Login</button>
                </div>
            </form>
        </div>
    </div>
