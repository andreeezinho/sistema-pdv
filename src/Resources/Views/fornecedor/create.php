...
?>
    ...
    <div class="p-8 rounded-lg mt-14">
        ...
        <div class="w-full bg-neutral-50 mt-6 p-4 rounded-lg">
            <h3 class="text-2xl text-center font-bold tracking-tight text-gray-900">Cadastrar Fornecedores</h3>
            ...
            <div class="md:w-2/3 mt-5 mx-auto">
                <form action="/fornecedores/cadastro" method="POST">
                    ...
                    <div class="text-center mt-8">
                        <a href="/fornecedores" class="bg-gray-400 hover:bg-gray-500 text-white font-bold py-2.5 px-4 rounded">Cancelar</a>
