...
<div class="mt-4 col-span-1">
    ...
    <input type="text" name="cep" id="cep" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" required value="<?= $fornecedor->cep ?? null ?>" />
</div>

<div class="mt-4 col-span-1">
    <label for="uf" class="block mb-1 text-sm font-medium text-gray-900">UF</label>
    <input type="text" name="uf" id="uf" maxlength=2 class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" required value="<?= $fornecedor->uf ?? null ?>" />
</div>
...
<div class="mt-4 col-span-1">
    ...
    <input type="text" name="cidade" id="cidade" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" required value="<?= $fornecedor->cidade ?? null ?>" />
</div>

<div class="mt-4 col-span-2">
    <label for="rua" class="block mb-1 text-sm font-medium text-gray-900">Rua</label>
    <input type="text" name="rua" id="rua" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" required value="<?= $fornecedor->rua ?? null ?>" />
</div>

<div class="mt-4 col-span-1">
    <label for="bairro" class="block mb-1 text-sm font-medium text-gray-900">Bairro</label>
    <input type="text" name="bairro" id="bairro" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" required value="<?= $fornecedor->bairro ?? null ?>" />
</div>

<div class="mt-4 col-span-1">
    <label for="numero" class="block mb-1 text-sm font-medium text-gray-900">N°</label>
    <input type="text" name="numero" id="numero" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" value="<?= $fornecedor->numero ?? null ?>" />
</div>

<div class="mt-4 col-span-1">
    <label for="complemento" class="block mb-1 text-sm font-medium text-gray-900">Complemento</label>
    <input type="text" name="complemento" id="complemento" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" value="<?= $fornecedor->complemento ?? null ?>" />
</div>