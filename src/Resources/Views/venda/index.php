                        ...
                        ?>
                            <tr class="bg-violet-100 border-b border-gray-400 text-gray-800">
                                ...
                                <td class="px-6 py-4 flex gap-x-2 justify-center">
                                    <a href="/vendas/<?= $venda->uuid ?>/editar" class="font-medium text-white p-2 rounded-lg text-center bg-violet-400 hover:bg-violet-700">
                                            ...
                                            <div class="relative p-4 w-full max-w-md max-h-full">
                                                <div class="relative bg-white rounded-lg shadow-sm">
                                                    ...
                                                    <div class="p-4 md:p-5 text-center">
                                                        ...
                                                        <form action="/vendas/<?= $venda->uuid ?>/deletar" method="POST">
                                                            <button type="submit" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                                                                Deletar
                                                            </button>
                                                            <button data-modal-hide="popup-modal-<?= $venda->uuid ?>" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100">Não, cancelar</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
